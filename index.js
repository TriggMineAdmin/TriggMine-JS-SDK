;(function () {
   ...
   * @param {Object} [opts.deviceId] - device ID generated by Fingerprint.js (for Node.js only)
   * @param {Object} [opts.deviceId1] - device ID generated by ClientJS (for Node.js only)
   *
   */
